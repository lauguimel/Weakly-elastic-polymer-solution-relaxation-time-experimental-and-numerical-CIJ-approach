...
\begin{figure}[h]
    \centering
    \includegraphics[width=15cm]{Encre/expAll.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=15cm]{LbInk_logLin.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{./visco.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=15cm]{dispersion.eps}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=15cm]{Glycerol/gouttes_exp.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=15cm]{LbGlycerol.eps}
...
\begin{figure}[h]
    \centering
\includegraphics[width=15cm]{microscope.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{dP.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{rProfilesInk.eps}

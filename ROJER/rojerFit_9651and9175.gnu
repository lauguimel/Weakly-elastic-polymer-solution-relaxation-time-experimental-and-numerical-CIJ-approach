...
plot "9651" using 1:4 title 'Ink C' w p ls 1, \
"9175" using 1:4 title 'Ink C' w p ls 1, \
"Newtonien" using 1:8 title '$1-\delta exp(qt)$' w l ls 1, \
exp((-x*310/(3*5.6))+15.38) title '$exp(-t / 3 \tau_E)$' w l ls 2
